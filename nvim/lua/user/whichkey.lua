...
local mappings = {
    ...
    { "<leader>a",  group = "A.I",                                                                                                       nowait = true,                 remap = false },
    { "<leader>at", "<cmd>Copilot toggle<cr>",                                                                                           desc = "Toggle Copilot",       nowait = true, remap = false },
    ...
    { "<leader>ll", "<cmd>lua vim.codelens.run()<cr>",                                                                                   desc = "CodeLens Action",      nowait = true, remap = false },
    ...
    { "<leader>lt", "<cmd>ErrorLensToggle<cr>",                                                                                          desc = "Toggle ErrorLens",     nowait = true, remap = false },
